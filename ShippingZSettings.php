...
define("SHIPPINGZSETTINGS_VERSION","3.0.0.62382");
...
define("Magento_Password","qAVE5rUthewrubewrUBr2w8awuh4tr");   // From Step M3 above. This is the Web Server user's "API Key" (see page 7 of the Magento-Setup-Document.pdf)
#
...
define("Magento_SendsShippingEmail",1);    

define("Magento_SendsShippingEmail_AddComments",1);  // defaults to 0, False, which suppresses our comments in "new shipment" notification email
...
define("SHIPPING_ACCESS_TOKEN","xupr8cetHeSWa7AprEPac26S7aVAJuk");  // See steps above to set this -- REQUIRED !
