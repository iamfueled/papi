...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
		...
		// FUELED - Main Article adding Custom Columns - http://www.atwix.com/magento/customize-orders-grid/
		...
		$collection->getSelect()->join('sales_flat_order_address', 'main_table.entity_id = sales_flat_order_address.parent_id',array('telephone','postcode','address'=>new Zend_Db_Expr('concat(sales_flat_order_address.street, ", ",sales_flat_order_address.city, ", ",sales_flat_order_address.country_id)')) );
		...
		// $collection->getSelect()->join('sales_flat_invoice', 'main_table.entity_id = sales_flat_invoice.parent_id',array('tax_amount'));
