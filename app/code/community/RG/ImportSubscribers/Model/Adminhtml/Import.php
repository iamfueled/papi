 ...
 * 
 */
class RG_ImportSubscribers_Model_Adminhtml_Import extends Mage_Core_Model_Config_Data
{
    public function _afterSave ()
    {
        Mage::getResourceModel('importsubscribers/import')->uploadAndImport( $this );
    }
}
