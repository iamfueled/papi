...
{         
	...
	$orders->addAttributeToSelect("updated_at")->getSelect()->where("(updated_at > '$start' AND updated_at <= '$end') AND state = 'processing' ");
	$count = $orders->count();
...
function Action_GetOrders()
{
	...
	$orders->addAttributeToSelect("*")
		->getSelect()
		->where("(updated_at > '$start' AND updated_at <= '$end' ) AND state = 'processing'")
